-- Script independiente de carga de datos iniciales extraído de bd_secam.sql
USE cctv_records;

-- 1. Centros Comerciales / Empresas
...
-- 4. Catálogos: Propietarios / Monitores
